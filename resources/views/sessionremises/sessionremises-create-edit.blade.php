<x-app-layout>
    <div class="container">
        <!-- Formulaire -->
        <form method="post" action="{{ $action === 'create' ? route('sessionremises.store') : route('sessionremises.edit', $sessionremise) }}" enctype="" class="">
            @csrf
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="">
                                ...
                                <div class="">
                                    <input type="text" id="code" name="code" class="form-control form-control-sm" value="{{ old('code') ?? $sessionremise->sercode }}" required />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="">
                                        <input type="date" id="datedebut" name="datedebut" class="form-control form-control-sm" value="{{ old('datedebut') ?? $sessionremise->serdatedebut }}" required />
                                    </div>
                                </div>
                                <!-- Date de fin -->
                                <div class="col-md-6">
                                    ...
                                    <div class="">
                                        <input type="date" id="datefin" name="datefin" class="form-control form-control-sm" value="{{ old('datefin') ?? $sessionremise->serdatefin }}" required />
                                    </div>
                                </div>
                            </div>
                            <!-- Commentaire -->
                            <div class="">
                                ...
                                <div class="">
                                    <input type="text" id="commentaire" name="commentaire" class="form-control form-control-sm" value="{{ old('commentaire') ?? $sessionremise->sercommentaire }}" />
                                </div>
                            </div>
                            <!--  -->
                        </div>
                        ...
                        <div class="card-footer text-end py-1">
                            ...
                            <a href="{{ route('sessionremises.index') }}" class="btn btn-sm btn-secondary"><i
