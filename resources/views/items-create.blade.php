...
<button type="button" class="btn btn-primary LaunchStaticBackdropModal mt-1 d-none" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body"> 
                    <div id="createAlertContainer" class="mb-1"></div>
                    @if (!empty($itemCreatePath))
                    @include($itemCreatePath)
                    @endif
                </div>
